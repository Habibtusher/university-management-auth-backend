...
const getDepartment = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const filterData = (0, pick_1.default)(
      req.query,
      academicDepartment_constant_1.academicDepartmentFilters
    );
    const result =
      yield academicDepartment_service_1.AcademicDepartmentService.getDepartmentFromDb(
        pagination,
        filterData
      );
    (0, sendResponse_1.default)(res, {
...
const updateDepartment = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result =
      yield academicDepartment_service_1.AcademicDepartmentService.updaterDepartmentInDb(
        id,
        updatedData
      );
    (0, sendResponse_1.default)(res, {
...
const singleDepartment = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const result =
