...
const createDepartmentToDb = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    const result = (yield academicDepartment_model_1.default.create(payload)).populate('academicFaculty');
    return result;
});
const getDepartmentFromDb = (pagination, filters) => __awaiter(void 0, void 0, void 0, function* () {
    const { page, limit, skip, sortBy, sortOrder } = (0, paginationHelper_1.calculatePagination)(pagination);
    const { searchTerm } = filters, filterData = __rest(filters, ["searchTerm"]);
    const andCondition = [];
    if (searchTerm) {
        andCondition.push({
            $or: academicDepartment_constant_1.academicDepartmentsearchFields.map(field => ({
                [field]: {
                    $regex: searchTerm,
                    $options: 'i',
                },
    ...
    const result = yield academicDepartment_model_1.default.find(whereCondition);
...
const deleteDepartmentFromDb = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield academicDepartment_model_1.default.findByIdAndDelete(id);
    return result;
});
const updaterDepartmentInDb = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
