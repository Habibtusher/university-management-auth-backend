...
const createAcademicFaculty = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result =
      yield academicFaculty_services_1.AcademicFacultyService.createAcademicFacultyToDb(
...
const getAcademicFaculty = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const filter = (0, pick_1.default)(
      req.query,
      academicFaculty_constant_1.academicFacultyFilters
    );
    ...
    const result =
      yield academicFaculty_services_1.AcademicFacultyService.getAcademicFacultyFromDb(
        filter,
        pagination
      );
    (0, sendResponse_1.default)(res, {
...
const getSingleAcademicFaculty = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const result =
      yield academicFaculty_services_1.AcademicFacultyService.getSingleAcademicFacultyFromDb(
        id
      );
    (0, sendResponse_1.default)(res, {
      statusCode: http_status_1.default.OK,
...
const updateAcademicFaculty = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result =
      yield academicFaculty_services_1.AcademicFacultyService.updateAcademicFacultyFromDb(
        id,
        updateData
      );
    (0, sendResponse_1.default)(res, {
...
const deleteAcademicFaculty = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const result =
      yield academicFaculty_services_1.AcademicFacultyService.deleteAcademicFacultyFromDb(
        id
      );
    (0, sendResponse_1.default)(res, {
      statusCode: http_status_1.default.OK,
