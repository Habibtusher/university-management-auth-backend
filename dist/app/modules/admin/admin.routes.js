...
router.patch('/:id', (0, validateRequest_1.default)(admin_validation_1.AdminZodValidationSchema.updateAdminZodSchema), admin_controller_1.AdminControllers.updateAdmin);
