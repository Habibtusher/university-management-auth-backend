...
exports.AdminService =
  exports.updateAdminDb =
  exports.deleteAdminDb =
  exports.getSingleAdminDb =
    void 0;
...
const getAllAdminDb = (filters, paginationOpt) =>
...
const deleteAdminDb = id =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      const deleteAdmin = yield admin_model_1.Admin.findOneAndDelete(
        { id },
        { session }
      ).populate('managementDepartment');
      if (!deleteAdmin) {
...
const updateAdminDb = (id, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { name } = payload,
      studentData = __rest(payload, ['name']);
