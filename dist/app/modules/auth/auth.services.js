...
const loginUserDb = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (isUserExist.password &&
        !user_model_1.default.isPasswordMatched(password, isUserExist === null || isUserExist === void 0 ? void 0 : isUserExist.password)) {
        throw new ApiError_1.default(http_status_1.default.UNAUTHORIZED, 'Password is incorect');
    }
...
const refreshTokenDb = (token) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        varifiedToken = jwtHelper_1.jwtHelpers.verifyToken(token, config_1.default.jwt.refresh_secret);
    }
    catch (error) {
    ...
    const newAccessToken = jwtHelper_1.jwtHelpers.createToken({ userId, role }, config_1.default.jwt.secret, config_1.default.jwt.expires_in);
    return {
...
const changePasswordDb = (user, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const isUserExist = yield user_model_1.default.isUserExist(user === null || user === void 0 ? void 0 : user.userId);
    if (!isUserExist) {
        throw new ApiError_1.default(http_status_1.default.NOT_FOUND, 'User not found');
    }
    const isPasswordMatched = yield user_model_1.default.isPasswordMatched(oldPassword, isUserExist.password);
    ...
    yield user_model_1.default.findOneAndUpdate({ id: user.userId }, {
