...
const getFaculties = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const filters = (0, pick_1.default)(
      req.query,
      faculty_const_1.facultyFilterableFields
    );
    const paginationOtp = (0, pick_1.default)(
      req.query,
      pagination_1.paginationFields
    );
    const result = yield faculty_services_1.FacultyService.getFacutiesFromDb(
      filters,
      paginationOtp
    );
...
const getSingleFaculty = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const result =
      yield faculty_services_1.FacultyService.getSingleFacultyFromDb(id);
    (0, sendResponse_1.default)(res, {
      statusCode: http_status_1.default.OK,
      success: true,
      message: 'faculty retrieved successfully!',
...
const updateFaculty = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const data = req.body;
    const result = yield faculty_services_1.FacultyService.updateFacultyDb(
      id,
      data
    );
    (0, sendResponse_1.default)(res, {
...
const deleteFaculty = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const result = yield faculty_services_1.FacultyService.deleteFacultyFromDb(
      id
    );
    (0, sendResponse_1.default)(res, {
      statusCode: http_status_1.default.OK,
