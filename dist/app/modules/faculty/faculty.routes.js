...
router.patch('/:id', (0, validateRequest_1.default)(faculty_validation_1.FacultyZodValidation.facultyUpdateZodSchema), faculty_controllers_1.FacultyControllers.updateFaculty);
