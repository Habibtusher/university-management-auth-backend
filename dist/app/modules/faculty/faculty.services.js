...
const getFacutiesFromDb = (filters, paginationOpt) => __awaiter(void 0, void 0, void 0, function* () {
    const andCondition = [];
...
const deleteFacultyFromDb = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const deleteFaculty = yield faculty_model_1.Faculty.findOneAndDelete({ id }, { session })
            .populate('department')
            .populate('faculty');
        if (!deleteFaculty) {
...
const updateFacultyDb = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = faculty_model_1.Faculty.findOneAndUpdate({ id }, updatedFacultytData, {
        new: true,
    })
        .populate('department')
        .populate('faculty');
