...
router.get(
  '/:id',
  student_controllers_1.StudentControllers.getSingleStudentByID
);
router.patch(
  '/:id',
  (0, validateRequest_1.default)(
    student_validation_1.StudentValidation.studentZodSchema
  ),
  student_controllers_1.StudentControllers.updateStudent
);
