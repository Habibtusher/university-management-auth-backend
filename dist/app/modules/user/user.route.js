...
router.post(
  ...
  (0, validateRequest_1.default)(
    user_validation_1.UserValidation.createStudentUserZodSchema
  ),
...
router.post(
  '/create-faculty',
  (0, validateRequest_1.default)(
    user_validation_1.UserValidation.createFacultyUserZodSchema
  ),
...
router.post(
  '/create-admin',
  (0, validateRequest_1.default)(
    user_validation_1.UserValidation.createAdminUserZodSchema
  ),
