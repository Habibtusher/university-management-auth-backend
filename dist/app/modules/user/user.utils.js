...
exports.generateAdminId =
  ...
  exports.findLastAdmintId =
  exports.findLastFacultytId =
...
const findLastFacultytId = () =>
  __awaiter(void 0, void 0, void 0, function* () {
    const lastFacculty = yield user_model_1.default
      .findOne(
        {
          role: 'faculty',
        },
    ...
    return (
      lastFacculty === null || lastFacculty === void 0
        ? void 0
        : lastFacculty.id
    )
      ? lastFacculty.id.substring(2)
      : undefined;
  });
exports.findLastFacultytId = findLastFacultytId;
const findLastAdmintId = () =>
  __awaiter(void 0, void 0, void 0, function* () {
    const lastAdmin = yield user_model_1.default
      .findOne(
        {
          role: 'admin',
        },
...
const generateFacultyId = () =>
  __awaiter(void 0, void 0, void 0, function* () {
    const currentId =
      (yield (0, exports.findLastFacultytId)()) ||
...
const generateAdminId = () =>
  __awaiter(void 0, void 0, void 0, function* () {
    const currentId =
      (yield (0, exports.findLastAdmintId)()) ||
      (0).toString().padStart(5, '0');
    //increment by 1
    let incrementedId = (parseInt(currentId) + 1).toString().padStart(5, '0');
